...
namespace FureverHome.Migrations
{
    ...
    [Migration("20240702104011_Update model references")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FureverHome.Models.Volunteer", b =>
                {
                    ...
                    b.Property<int?>("VolunteerApplicationId1")
                        .HasColumnType("integer");

                    b.HasIndex("VolunteerApplicationId");

                    b.HasIndex("VolunteerApplicationId1");
            ...
            modelBuilder.Entity("FureverHome.Models.VolunteerApplication", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("VolunteerApplication");
                });
            ...
            modelBuilder.Entity("FureverHome.Models.Volunteer", b =>
                {
                    ...
                    b.HasOne("FureverHome.Models.VolunteerApplication", null)
                        .WithMany("YesVotes")
                        .HasForeignKey("VolunteerApplicationId1");
                });
            ...
            modelBuilder.Entity("FureverHome.Models.VolunteerApplication", b =>
                {
                    b.Navigation("NoVotes");

                    b.Navigation("YesVotes");
                });
