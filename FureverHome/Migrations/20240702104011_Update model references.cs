        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnimalBreeds_AnimalSpecies_AnimalSpeciesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnimalBreedId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimalReviews", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Text = table.Column<string>(type: "text", nullable: false),
                    FromAssociation = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimesReturned = table.Column<int>(type: "integer", nullable: true),
                    VolunteerApplicationId = table.Column<int>(type: "integer", nullable: true),
                    VolunteerApplicationId1 = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.VolunteerApplicationId1,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimalBreeds_AnimalSpeciesId",
                table: "AnimalBreeds",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_RegisteredUserId",
                table: "Messages",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AnimalReviews_Users_UserId",
                table: "AnimalReviews",
                column: "UserId",
                principalTable: "Users",
                principalColumn: "Id",
